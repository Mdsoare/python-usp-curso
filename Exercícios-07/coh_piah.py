...
Descrição: Escreva um programa que simule um detector de cópia (COH-PIAH).
"""
...
def main():
    ...
    if lista_textos:
        numero_infectado = avalia_textos(lista_textos, assinatura_modelo)
        print(f"\nO autor do texto {numero_infectado} está infectado com COH-PIAH!")
    else:
